...
export default {
  ...
  methods: {
    fetchAppointments() {
      ...
      fetch("https://631yjambq5.execute-api.us-east-1.amazonaws.com/prod/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://631yjambq5.execute-api.us-east-1.amazonaws.com/prod/appointments/${appointment.appointmentId}`;
